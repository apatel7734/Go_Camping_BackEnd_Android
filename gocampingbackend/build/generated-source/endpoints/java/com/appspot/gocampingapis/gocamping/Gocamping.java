...
public class Gocamping extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * An accessor for creating requests from the FamilyEndpoint collection.
   *
   * <p>The typical use is:</p>
   * <pre>
   *   {@code Gocamping gocamping = new Gocamping(...);}
   *   {@code Gocamping.FamilyEndpoint.List request = gocamping.familyEndpoint().list(parameters ...)}
   * </pre>
   *
   * @return the resource collection
   */
  public FamilyEndpoint familyEndpoint() {
    return new FamilyEndpoint();
  }

  /**
   * The "familyEndpoint" collection of methods.
   */
  public class FamilyEndpoint {

    /**
     * Create a request for the method "familyEndpoint.sendMessageTest".
     *
     * This request holds the parameters needed by the gocamping server.  After setting any optional
     * parameters, call the {@link SendMessageTest#execute()} method to invoke the remote operation.
     *
     * @return the request
     */
    public SendMessageTest sendMessageTest() throws java.io.IOException {
      SendMessageTest result = new SendMessageTest();
      initialize(result);
      return result;
    }

    public class SendMessageTest extends GocampingRequest<Void> {

      private static final String REST_PATH = "sendMessageTest";

      /**
       * Create a request for the method "familyEndpoint.sendMessageTest".
       *
       * This request holds the parameters needed by the the gocamping server.  After setting any
       * optional parameters, call the {@link SendMessageTest#execute()} method to invoke the remote
       * operation. <p> {@link SendMessageTest#initialize(com.google.api.client.googleapis.services.Abst
       * ractGoogleClientRequest)} must be called to initialize this instance immediately after invoking
       * the constructor. </p>
       *
       * @since 1.13
       */
      protected SendMessageTest() {
        super(Gocamping.this, "GET", REST_PATH, null, Void.class);
      }
      ...
      @Override
      public SendMessageTest setAlt(java.lang.String alt) {
        return (SendMessageTest) super.setAlt(alt);
      }

      @Override
      public SendMessageTest setFields(java.lang.String fields) {
        return (SendMessageTest) super.setFields(fields);
      }

      @Override
      public SendMessageTest setKey(java.lang.String key) {
        return (SendMessageTest) super.setKey(key);
      }

      @Override
      public SendMessageTest setOauthToken(java.lang.String oauthToken) {
        return (SendMessageTest) super.setOauthToken(oauthToken);
      }

      @Override
      public SendMessageTest setPrettyPrint(java.lang.Boolean prettyPrint) {
        return (SendMessageTest) super.setPrettyPrint(prettyPrint);
      }

      @Override
      public SendMessageTest setQuotaUser(java.lang.String quotaUser) {
        return (SendMessageTest) super.setQuotaUser(quotaUser);
      }

      @Override
      public SendMessageTest setUserIp(java.lang.String userIp) {
        return (SendMessageTest) super.setUserIp(userIp);
      }

      @Override
      public SendMessageTest set(String parameterName, Object value) {
        return (SendMessageTest) super.set(parameterName, value);
      }
    }
