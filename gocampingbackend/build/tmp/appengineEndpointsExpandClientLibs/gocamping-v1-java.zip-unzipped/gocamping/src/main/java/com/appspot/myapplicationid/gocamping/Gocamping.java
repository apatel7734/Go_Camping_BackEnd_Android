...
public class Gocamping extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   *
   * @param campingTripId
   * @param content the {@link com.appspot.myapplicationid.gocamping.model.Expense}
   * @return the request
   */
  public AddExpense addExpense(java.lang.Long campingTripId, com.appspot.myapplicationid.gocamping.model.Expense content) throws java.io.IOException {
  ...
  public class AddExpense extends GocampingRequest<Void> {
     ...
     * @since 1.13
     */
    protected AddExpense(java.lang.Long campingTripId, com.appspot.myapplicationid.gocamping.model.Expense content) {
   ...
   * @param familyID
   * @param campingTripId
   * @param content the {@link com.appspot.myapplicationid.gocamping.model.Member}
   * @return the request
   */
  public AddMember addMember(java.lang.Long familyID, java.lang.Long campingTripId, com.appspot.myapplicationid.gocamping.model.Member content) throws java.io.IOException {
  ...
  public class AddMember extends GocampingRequest<Void> {
     ...
     * @since 1.13
     */
    protected AddMember(java.lang.Long familyID, java.lang.Long campingTripId, com.appspot.myapplicationid.gocamping.model.Member content) {
      super(Gocamping.this, "POST", REST_PATH, content, Void.class);
  ...
  public class GetAllFamilyExpenses extends GocampingRequest<com.appspot.myapplicationid.gocamping.model.ExpenseCollection> {
    ...
    protected GetAllFamilyExpenses(java.lang.Long familyID) {
      super(Gocamping.this, "POST", REST_PATH, null, com.appspot.myapplicationid.gocamping.model.ExpenseCollection.class);
      this.familyID = com.google.api.client.util.Preconditions.checkNotNull(familyID, "Required parameter familyID must be specified.");
    }
  ...
  public class GetAllFamilyMembers extends GocampingRequest<com.appspot.myapplicationid.gocamping.model.MemberCollection> {
    ...
    protected GetAllFamilyMembers(java.lang.Long familyId) {
      super(Gocamping.this, "POST", REST_PATH, null, com.appspot.myapplicationid.gocamping.model.MemberCollection.class);
      this.familyId = com.google.api.client.util.Preconditions.checkNotNull(familyId, "Required parameter familyId must be specified.");
    }
  ...
  public class GetFamily extends GocampingRequest<com.appspot.myapplicationid.gocamping.model.Family> {
    ...
    protected GetFamily(java.lang.Long familyID) {
      super(Gocamping.this, "POST", REST_PATH, null, com.appspot.myapplicationid.gocamping.model.Family.class);
      this.familyID = com.google.api.client.util.Preconditions.checkNotNull(familyID, "Required parameter familyID must be specified.");
    }
  ...
  public class GetMember extends GocampingRequest<com.appspot.myapplicationid.gocamping.model.Member> {
    ...
    protected GetMember(java.lang.Long memberId) {
      super(Gocamping.this, "POST", REST_PATH, null, com.appspot.myapplicationid.gocamping.model.Member.class);
      this.memberId = com.google.api.client.util.Preconditions.checkNotNull(memberId, "Required parameter memberId must be specified.");
    }
   ...
   *
   * @param content the {@link com.appspot.myapplicationid.gocamping.model.FamilyRSVPWrapper}
   * @return the request
   */
  public RsvpForTheFamily rsvpForTheFamily(com.appspot.myapplicationid.gocamping.model.FamilyRSVPWrapper content) throws java.io.IOException {
  ...
  public class RsvpForTheFamily extends GocampingRequest<Void> {
     ...
     * @since 1.13
     */
    protected RsvpForTheFamily(com.appspot.myapplicationid.gocamping.model.FamilyRSVPWrapper content) {
      super(Gocamping.this, "POST", REST_PATH, content, Void.class);
    }
   ...
   * @return the request
   */
  public UpdateExpense updateExpense(com.appspot.myapplicationid.gocamping.model.Expense content) throws java.io.IOException {
  ...
  public class UpdateExpense extends GocampingRequest<Void> {
     ...
     * @since 1.13
     */
    protected UpdateExpense(com.appspot.myapplicationid.gocamping.model.Expense content) {
      super(Gocamping.this, "POST", REST_PATH, content, Void.class);
    }
